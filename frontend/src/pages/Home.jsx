...
const Home = () => {
    ...
    return (
        <div className={`h-screen relative overflow-hidden ${confirmRidePanel || vehicleFound || waitingForDriver ? 'overflow-y-hidden' : ''}`}>
            {/* Welcome message */}
            {user && (
            ...
            {/* Only show the main booking panel if NO overlay is active */}
            ...
            {/* VehiclePanel should only show if no other overlay is active */}
            {vehiclePanel && !confirmRidePanel && !vehicleFound && !waitingForDriver && (
                <div ref={vehiclePanelRef} className="fixed w-full z-10 bottom-0 bg-white px-3 py-6 sm:py-10 pt-10 sm:pt-12">
                    <VehiclePanel
            ...
            {confirmRidePanel && (
                <div className='fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40'>
                    <div className='bg-white rounded-xl shadow-lg w-[95%] max-w-md mx-auto p-4 sm:p-8'>
                        <ConfirmRide
